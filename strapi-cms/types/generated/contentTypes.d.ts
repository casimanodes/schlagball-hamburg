...
export interface ApiPlayerProfilePlayerProfile
  ...
  info: {
    description: 'Spielerprofile f\u00FCr die Vereinswebseite';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    rank: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTrainingEventTrainingEvent
  ...
  info: {
    description: 'Trainingstage, Turniere und Veranstaltungen';
    displayName: 'TrainingEvent';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['training', 'hallentraining', 'turnier', 'event']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTrainingPostTrainingPost
  extends Struct.CollectionTypeSchema {
  collectionName: 'training_posts';
  info: {
    description: 'Blog-Beitr\u00E4ge und Vereinsneuigkeiten';
    displayName: 'TrainingPost';
    pluralName: 'training-posts';
    singularName: 'training-post';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::training-post.training-post'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::training-post.training-post': ApiTrainingPostTrainingPost;
